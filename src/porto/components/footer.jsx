  ...
  return (
    <div className="w-full px-0 bg-white shadow flex flex-col justify-center items-center font-primary">
      <div className="w-full flex flex-col justify-center items-center">
        <div className="w-full py-7 bg-white flex justify-center items-center flex-wrap px-20 text-sm md:text-base">
          <Link
            to="/"
        ...
        <div className="w-full py-7 flex justify-center items-center text-black text-sm font-bold text-center sm:text-lg">
