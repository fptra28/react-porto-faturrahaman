  ...
  return (
    <div
      ...
      <div className="flex justify-center items-center gap-1">
        <img className="w-[40px] h-[40px] md:w-[55px] md:h-[55px] lg:w-[60px] lg:h-[60px]" src="/assets/logoSenfuri0n.png" alt="Logo" />
        <div className="text-black text-base sm:text-lg md:text-xl xl:text-2xl font-bold">Faturrahman Ptra</div>
      </div>
      <div className="hidden h-full md:flex items-center">
        <NavLink
          to="/"
          className={`h-full px-4 flex items-center ${
            isActive("/") ? "bg-red-800 text-white" : "text-black hover:bg-red-800 hover:text-neutral-50 transition duration-300 ease-in-out"
          }`}>
          <div className="text-base sm:text-lg md:text-xl xl:text-xl font-bold uppercase">HOME</div>
        </NavLink>
        <NavLink
          to="/portfolio"
          className={`h-full px-4 flex items-center ${
            isActive("/portfolio") ? "bg-red-800 text-white" : "text-black hover:bg-red-800 hover:text-neutral-50 transition duration-300 ease-in-out"
          }`}>
          <div className="text-base sm:text-lg md:text-xl xl:text-xl font-bold uppercase">Portfolio</div>
        </NavLink>
        <NavLink
          to="/about"
          className={`h-full px-4 flex items-center ${
            isActive("/about") ? "bg-red-800 text-white" : "text-black hover:bg-red-800 hover:text-neutral-50 transition duration-300 ease-in-out"
          }`}>
          <div className="text-base sm:text-lg md:text-xl xl:text-xl font-bold uppercase">ABOUT</div>
        </NavLink>
        <div className="ps-4">
          <NavLink
