...
export default function RelatedNewsSection({ items }: RelatedNewsSectionProps) {
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h6 className="text-lg font-semibold text-white">Related News</h6>
